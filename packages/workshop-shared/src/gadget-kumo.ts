/**
 * Platform-owned UI runtime injected before every Gadget client. Gadget code is intentionally
 * dependency-free, so this exposes the small, DOM-native subset of Kumo that Gadgets need most.
 */
...
/** Makes the platform runtime and Gadget client one atomic UI bundle. */
