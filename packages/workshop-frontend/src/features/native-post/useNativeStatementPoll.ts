...
export const useNativeStatementPoll = (session: RpcStub<NativePostSession> | null, detail: NativeCaptureDetail | null, paused: boolean, onDetail: (value: NativeCaptureDetail) => void) => {
  ...
  }, [session, id, attemptId, serverDeadline, paused])
  return message
}
