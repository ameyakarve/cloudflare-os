...
const scriptPath = resolve('.wrangler/native-post-human/canonical.mjs');
...
export default defineConfig({
  plugins: [{name: 'paired-text-modules', enforce: 'pre',
    ...
    main: './__tests__/native-post-human/worker.ts',
    miniflare: {
  ...
  test: {include: ['__tests__/native-post-human/*.test.ts'], setupFiles: ['@gadgets/scripts/assert-workerd'],
